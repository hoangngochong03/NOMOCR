...
det_model=PaddleOCR(use_angle_cls=False,use_gpu=False)
...
with st.sidebar:
    ...
    url = st.text_input('Image URL:', 'https://lib.nomfoundation.org/site_media/nom/nlvnpf-0153-01/jpeg/nlvnpf-0153-01-003.jpg')
...
with col1:
    ...
    with st.spinner('Detecting bounding boxes containing text...'):
        ...
        results=det_model.ocr(raw_image, det=True, rec=False)
        boxes = []
        for res in results[0]:
            box_coords = res  # first element is the 4 corners
